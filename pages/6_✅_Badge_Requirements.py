...
st.markdown("*The Display Name feature gives you full control over how your name is displayed on any badge that issued. This is done on the :star: page.*") 
st.markdown("")
...
st.markdown('---------------------')
st.markdown("**STEP 4:** For EVERY BADGE you hope to recieve, you need to complete every DORA check and see both PASSED and VALID for that test.") 
