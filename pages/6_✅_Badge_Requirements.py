...
if 'auth_status' not in st.session_state or st.session_state.auth_status == 'not_authed': 
   ...
   st.markdown(":question_mark: **STEP 4:** For EVERY BADGE you hope to recieve, you need to complete every DORA check and see both PASSED and VALID for that test.") 
