   ...
   st.markdown(":red[Please sign in using your UNI_ID and UUID in the sidebar of the homepage.]")
         ...
         if mw_choice:
                ...
                if amt_rows > 0:    
                        ...
                        st.write("NOTE: If no rows are loaded make sure you have created your LINK row correctly. If you have confirmed your LINK row is accurate, consider whether the app may have timed out. Try logging in again if some time has passed.")
